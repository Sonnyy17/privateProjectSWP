                    ...
                    <main class="flex-1 overflow-x-hidden bg-gray-200">
                        ...
                        <div class="container px-6 py-8 mx-auto">
                            <div class="flex justify-between">
                                <button style="background-color: darkseagreen;color: black" onclick="window.location.href='${pageContext.request.contextPath}/MainController?action=CreatePage'" >Add New Account</button>
                                <div>
                                            ...
                                            <tbody class="bg-white">
                                                ...
                                                <tr>
                                                    ...
                                                    <td
                                                        class="px-6 py-4 whitespace-no-wrap border-b border-gray-200"
                                                        >
                                                        <img src="img/<%=user.getPhoto()%>" style="width: 150px;height: 100px">
                                                    </td>
                                                    <td
                                                        ...
                                                        <div class="flex justify-center items-center">
                                                            <div class="pl-2">
                                                                <button
                                                                    ...
                                                                    onclick="window.location.href='${pageContext.request.contextPath}/UpdateController?userID=<%=user.getEmployee_id()%>'">
                                                                    <svg
