                    ...
                    <div class="flex flex-row mb-1 sm:mb-0">
                        ...
                        <div class="relative">
                            <form action="ListFeedback">
                                <select onchange="this.form.submit()" name="status" class="appearance-none h-full rounded-r border-t sm:rounded-r-none sm:border-r-0 border-r border-b block appearance-none w-full bg-white border-gray-400 text-gray-700 py-2 px-4 pr-8 leading-tight focus:outline-none focus:border-l focus:border-r focus:bg-white focus:border-gray-500">
                                ...
                                <tbody class="bg-white">
                                    <tr>
                                        ...
                                        <c:if test="${f.status eq 'APPROVED'}">
                                            <td class="px-6 py-4 font-bold leading-5 text-green-500 border-b border-gray-200 border-r">
                                                ...
                                                <button class="btn group flex  bg-transparent  text-xl  tracking-widest text-white">
                                                    <span class="relative pr-4 pb-1 text-white after:transition-transform after:duration-500 after:ease-out after:absolute after:bottom-0 after:left-0 after:block after:h-[2px] after:w-full after:origin-bottom-right after:scale-x-0 after:bg-blue-500 after:content-[''] after:group-hover:origin-bottom-left after:group-hover:scale-x-100"><a href="update?fid=${f.feedback_id}" class="text-blue-500 "> CHECK</a></span>
                                        ...
                                        <c:if test="${f.status eq 'REJECTED'}">
                                            <td class="px-6 py-4 font-bold leading-5 text-red-500 border-b border-gray-200 border-r">
                                                ${f.status}
                                            ...
                                            <td class="px-6 py-4 font-bold leading-5 text-grey-500 border-b border-gray-200 border-r">
                                                ${f.status}
